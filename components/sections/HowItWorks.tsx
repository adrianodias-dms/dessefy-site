    ...
    <section id="como-funciona" className="section" aria-labelledby="process-heading">
      <div className="container">
        <div className="process-intro reveal">
          ...
          <p className="section-sub">Um processo estruturado e transparente — do mapeamento dos gargalos à entrega de resultados mensuráveis.</p>
        </div>

        <div className="timeline" role="list">
          <div className="t-step reveal d1" role="listitem">
            <div className="t-num" aria-label="Etapa 1">
              1
            </div>
          ...
          <div className="t-step reveal d2" role="listitem">
            <div className="t-num" aria-label="Etapa 2">
              2
            </div>
            <div className="t-body">
          ...
          <div className="t-step reveal d3" role="listitem">
            <div className="t-num" aria-label="Etapa 3">
              3
            </div>
            <div className="t-body">
              <h3>Integração</h3>
          ...
          <div className="t-step reveal d4" role="listitem">
            <div className="t-num" aria-label="Etapa 4">
              4
            </div>
            <div className="t-body">
              <h3>Implantação</h3>
          ...
          <div className="t-step reveal d5" role="listitem">
            <div className="t-num" aria-label="Etapa 5">
              5
            </div>
            <div className="t-body">
