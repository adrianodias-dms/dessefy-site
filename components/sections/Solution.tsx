        ...
        <div className="solution-layout">
          <div className="reveal">
            ...
            <h2 className="section-title" id="sol-heading">
              Não substituímos o que você usa
              <br />
              <span className="gradient-text">Adicionamos inteligência sobre ele</span>
            </h2>
          </div>
          <div className="reveal d2">
            <p className="section-sub">Dessefy elimina trabalho manual e transforma dados dispersos em decisões estratégicas — sem migração, sem ruptura operacional.</p>
          </div>
        </div>

        <div className="solution-grid">
          <div className="sol-card reveal d1">
            <div className="sol-num" aria-hidden="true">
              01
            </div>
