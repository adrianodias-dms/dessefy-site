        ...
        <div className="why-layout">
          <div className="why-card reveal d1">
            <p className="why-card-quote">
              &ldquo;Cada solução é construída por quem entende o <span className="gradient-text">processo</span> e o <span className="gradient-text">negócio do cliente</span>&nbsp;ao mesmo
              tempo.&rdquo;
            </p>
            <p className="why-card-body">
              A Dessefy nasce do ecossistema DMS — integrando a expertise técnica do Salum Duque Advogados com a visão estratégica da DMS. Profundidade jurídica e visão de negócio na mesma solução.
              Nada genérico, nada de prateleira.
            </p>
          </div>
